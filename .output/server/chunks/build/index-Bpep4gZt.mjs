import { _ as __nuxt_component_0$1 } from './nuxt-link-3PxKSZG8.mjs';
import { C as isEqual } from '../runtime.mjs';
import { defineComponent, useSSRContext, computed, toRef, useAttrs, toValue, getCurrentInstance, inject, onUnmounted, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString } from 'vue';
import { b as useAppConfig, m as mergeConfig, f as appConfig, d as defineStore, _ as _export_sfc } from './server.mjs';
...
import __nuxt_component_0$2 from './Icon-B98aE4wR.mjs';
...
const useMovieStore = defineStore("movieStore", {
  ...
  getters: {
    watchedMovies: (state) => {
      return state.movies.filter((item) => item == null ? void 0 : item.isWatched);
    },
...
export { __nuxt_component_1 as _, useMovieStore as u };
//# sourceMappingURL=index-Bpep4gZt.mjs.map
