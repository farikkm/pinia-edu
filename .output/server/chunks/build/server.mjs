...
import { d as useRuntimeConfig$1, $ as $fetch, w as withQuery, l as hasProtocol, p as parseURL, m as isScriptProtocol, j as joinURL, n as defuFn, o as klona, q as defu, r as sanitizeStatusCode, t as createDefu, v as createHooks, h as createError$1, x as toRouteMatcher, y as createRouter$1 } from '../runtime.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-BPBWRYC7.mjs').then((m) => m.default || m)
  },
  {
    name: "search",
    path: "/search",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./search-Bg4NKb3S.mjs').then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  redirect: () => import('./redirect-CSwjhMGm.mjs')
};
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-B98aE4wR.mjs').then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-EUUwRFks.mjs').then((r) => r.default));
...
const layouts = {
  default: () => import('./default-Cmu49Oi0.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DxXAlOiT.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-DOm5iaEX.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, defineNuxtRouteMiddleware as a, useAppConfig as b, useNuxtApp as c, defineStore as d, entry$1 as default, useRuntimeConfig as e, appConfig as f, useRouter as g, nuxtLinkDefaults as h, useState as i, mergeConfig as m, navigateTo as n, storeToRefs as s, useHead as u };
